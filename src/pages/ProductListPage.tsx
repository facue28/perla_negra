...
const ProductListPage = (): React.ReactElement => {
    ...
    const pageTitle = selectedCategories.length === 1
        ? `${selectedCategories[0]} - Catalogo`
        : 'Catalogo Prodotti';

    const pageDescription = selectedCategories.length > 0
        ? `Esplora la nostra collezione di ${selectedCategories.join(', ')}. Prodotti premium per il tuo benessere.`
        : "Esplora la nostra selezione di prodotti premium. Lubrificanti, profumi e accessori.";
