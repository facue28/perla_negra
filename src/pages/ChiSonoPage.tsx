                    ...
                    <div className="md:col-span-7 flex flex-col justify-center py-4 md:py-8">
                        <Reveal delay={0.1}>
                            <div className="mb-8 md:mb-10 border-l-2 border-accent/30 pl-6">
                                <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif text-white tracking-wide uppercase mb-3">
                                    Chi Sono
                                </h1>
                            ...
                            <Reveal delay={0.5}>
                                <div className="text-text-muted text-base md:text-lg leading-relaxed space-y-4">
                                    <p>
                                        ...
                                        Qui ho trovato la fuerza e l'opportunità di ricominciare, portando con me la mia esperienza.
                                    </p>
