...
const ChiSonoPage = () => {
    return (
        <div className="bg-background-dark h-[calc(100vh-80px)] w-full flex items-center justify-center p-4 overflow-hidden">
            ...
            <div className="max-w-6xl w-full h-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center">
                ...
                <div className="flex flex-col h-full justify-center py-2 md:py-4 pl-4 md:pl-0">
                    <div className="flex-shrink-0 mb-4 md:mb-6">
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-serif text-text-primary tracking-wide uppercase whitespace-nowrap mb-2">
                    ...
                    <div className="text-text-muted text-xs md:text-sm lg:text-base text-justify flex flex-col gap-3 md:gap-4 pr-4 md:pr-8">
                        <p>
