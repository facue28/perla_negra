-- ==============================================================================
-- 🔧 HOTFIX V2: Fix column names (image -> image_url)
-- ==============================================================================
-- Error: "column 'image' does not exist"
-- Causa: La tabla products tiene image_url, no image
-- Este script corrige AMBOS errores: v_coupon y nombres de columna
-- ==============================================================================
...
BEGIN
    ...
    FOR v_item IN SELECT * FROM jsonb_array_elements(p_items) LOOP
        ...
        -- FIX: Usar image_url en lugar de image
...
SELECT 'HOTFIX V2: Column names corrected - READY TO TEST' as status;
