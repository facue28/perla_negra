...
import { AdminOrder, OrderStatus } from '@/features/admin/types';
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-grow">
                                                        ...
                                                        <p className="text-text-muted text-sm">
                                                            €{parseValue(item.price).toFixed(2)} × {item.quantity}
                                                        </p>
                                                    </div>
                                                    <div className="text-right">
                                                        <p className="text-white font-bold">
                                                            €{parseValue(item.subtotal).toFixed(2)}
                                                        </p>
                                                    </div>
                                                </div>
                                            ))}
                                    ...
                                    <div className="bg-white/5 rounded-2xl p-5 border border-white/5">
                                        ...
                                        <div className="space-y-2 text-sm">
                                            <div className="flex justify-between">
                                                ...
                                                <span className="text-white">€{parseValue(order.subtotal).toFixed(2)}</span>
                                            </div>
                                            {parseValue(order.discount_amount) > 0 && (
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <span className="text-accent">-€{parseValue(order.discount_amount).toFixed(2)}</span>
                                                </div>
                                            )}
                                            <div className="flex justify-between pt-3 border-t border-white/10 text-lg">
                                                <span className="text-white font-bold">Total</span>
                                                <span className="text-accent font-bold">€{parseValue(order.total).toFixed(2)}</span>
                                            </div>
                                        </div>
                                    </div>
